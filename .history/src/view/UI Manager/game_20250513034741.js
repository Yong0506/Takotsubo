...
function showFeedback(correct, feedbackId) {
    ...
    // Disable all choice buttons in the current scenario modal
    // Assumes your choice buttons are within a container with class 'choice' inside the scenario modal
    const choiceButtons = document.querySelectorAll(`#${scenarioModalId} .choice button`);
